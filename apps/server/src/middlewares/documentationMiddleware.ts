...
import internalSpecification from '#src/assets/internal.openapi.json' assert { type: 'json' };
import publicSpecification from '#src/assets/public.openapi.json' assert { type: 'json' };
