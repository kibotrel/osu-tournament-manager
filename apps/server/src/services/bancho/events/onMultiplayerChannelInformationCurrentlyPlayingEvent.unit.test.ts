...
import { onMultiplayerChannelInformationCurrentlyPlaying } from './onMultiplayerChannelInformationCurrentlyPlayingEvent.js';
...
const mockOldMatchState: BanchoLobbyState = {
  ...
  activeBeatmap: {
    ...
    url: 'ohttps://osu.ppy.sh/beatmapsets/400078#mania/992512',
  },
};
const newMatchState: BanchoLobbyState = {
  ...
  globalModifications: [],
  activeBeatmap: {
    name: 'Glamour Of The Kill - A Hope In Hell',
