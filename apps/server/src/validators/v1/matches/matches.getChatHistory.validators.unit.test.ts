...
import { getMatchChatHistoryValidators } from './matches.getChatHistory.validators.js';

describe('getMatchChatHistoryValidators', () => {
  describe('gameMatchId', () => {
    it('should pass when it is a positive integer string', async () => {
      const request = { params: { gameMatchId: '1' } };
      const validators = getMatchChatHistoryValidators();
